...
.constant('Constants', {
    ...
    DEFAULT_CURRENCY: localStorage.getItem('insight-currency') || 'CMM'
...
angular.module('insight').config(function($routeProvider) {
  $routeProvider.
    ...
    when('/blocks', {
      ...
      title: 'Commercium Blocks solved Today'
    }).
    when('/blocks-date/:blockDate/:startTimestamp?', {
      templateUrl: 'views/block_list.html',
      title: 'Commercium Blocks solved '
    }).
    when('/address/:addrStr', {
      templateUrl: 'views/address.html',
      title: 'Commercium Address '
    }).
	 when('/charts', {
