...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      css: {
        src: ['public/lib/c3/c3.min.css', 'public/src/css/**/*.css'],
